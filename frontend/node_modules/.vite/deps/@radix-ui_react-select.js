...
import {
  ...
  useLayoutEffect2,
  useSize
} from "./chunk-W4ZY6UUT.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-UVF5WH67.js";
import {
  require_react_dom
} from "./chunk-PFT53F37.js";
import {
  require_jsx_runtime
} from "./chunk-3IWZD7CS.js";
import {
  createSlot,
  useComposedRefs
} from "./chunk-IDZVPUQY.js";
import {
  require_react
} from "./chunk-YMZTTFQI.js";
import {
  __privateAdd,
  __privateGet,
  __privateSet,
...
var DismissableLayerBranch = React5.forwardRef(__name5(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React5.useContext(DismissableLayerContext);
...
__name6(FocusGuards, "FocusGuards");
...
__name6(useFocusGuards, "useFocusGuards");
...
__name6(createFocusGuard, "createFocusGuard");
...
var FocusScope = React7.forwardRef(
  __name7(function FocusScope2(props, forwardedRef) {
    const {
      loop = false,
      trapped = false,
    ...
    React7.useEffect(() => {
      if (trapped) {
        ...
        __name7(handleFocusIn2, "handleFocusIn");
        __name7(handleFocusOut2, "handleFocusOut");
        __name7(handleMutations2, "handleMutations");
...
__name7(getTabbableEdges, "getTabbableEdges");
...
__name7(findVisible, "findVisible");
...
__name7(isHidden, "isHidden");
function isSelectableInput(element) {
  return element instanceof HTMLInputElement && "select" in element;
}
__name7(isSelectableInput, "isSelectableInput");
...
__name7(createFocusScopesStack, "createFocusScopesStack");
...
__name7(removeLinks, "removeLinks");
...
var PopperAnchor = React11.forwardRef(
  __name10(function PopperAnchor2(props, forwardedRef) {
    ...
    return virtualRef ? null : (0, import_jsx_runtime7.jsx)(
      Primitive.div,
      {
...
var PopperContent = React11.forwardRef(
  __name10(function PopperContent2(props, forwardedRef) {
    const {
      __scopePopper,
      side = "bottom",
      sideOffset = 0,
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      whileElementsMounted: __name10((...args) => {
      ...
      middleware: [
        ...
        size3({
          ...detectOverflowOptions,
          apply: __name10(({ elements, rects, availableWidth, availableHeight }) => {
...
var PopperArrow = React11.forwardRef(
  __name10(function PopperArrow2(props, forwardedRef) {
...
__name10(isNotNull, "isNotNull");
var transformOrigin = __name10((options2) => ({
...
__name10(getSideAndAlignFromPlacement, "getSideAndAlignFromPlacement");
var Root2 = Popper;
...
var Portal = React12.forwardRef(
  __name11(function Portal2(props, forwardedRef) {
    const { container: containerProp, ...portalProps } = props;
    const [mounted, setMounted] = React12.useState(false);
    useLayoutEffect2(() => setMounted(true), []);
    const container = containerProp || mounted && globalThis?.document?.body;
    return container ? ReactDOM2.createPortal((0, import_jsx_runtime8.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
  }, "Portal")
);
...
__name13(usePrevious, "usePrevious");
...
function SelectProvider(props) {
  ...
  const initialValueRef = React26.useRef(value);
  React26.useEffect(() => {
    const associatedForm = form ? trigger?.ownerDocument.getElementById(form) : trigger?.form;
    if (associatedForm instanceof HTMLFormElement) {
      const reset = __name15(() => setValue(initialValueRef.current), "reset");
  ...
  const handleNativeOptionAdd = React26.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React26.useCallback((option) => {
  ...
  return (0, import_jsx_runtime10.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime10.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime10.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime10.jsx)(
...
__name15(SelectProvider, "SelectProvider");
var Select = __name15((props) => {
  ...
  return (0, import_jsx_runtime10.jsx)(
    SelectProvider,
    {
      __scopeSelect,
      ...providerProps,
      internal_do_not_use_render: ({ isFormControl }) => (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
        children,
...
var SelectTrigger = React26.forwardRef(
  __name15(function SelectTrigger2(props, forwardedRef) {
    ...
    const handleOpen = __name15((pointerEvent) => {
      if (!isDisabled) {
...
var SelectValue = React26.forwardRef(
  __name15(function SelectValue2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime10.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime10.jsx)(React26.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }, "SelectValue")
);
var SelectIcon = React26.forwardRef(
  __name15(function SelectIcon2(props, forwardedRef) {
...
var SelectPortal = __name15((props) => {
  const { __scopeSelect, forceMount, ...portalProps } = props;
  return (0, import_jsx_runtime10.jsx)(PortalProvider, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime10.jsx)(Portal, { asChild: true, ...portalProps }) });
}, "SelectPortal");
var CONTENT_NAME2 = "SelectContent";
var SelectContent = React26.forwardRef(
  __name15(function SelectContent2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime10.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime10.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime10.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }, "SelectContent")
);
var SelectContentFragment = React26.forwardRef(__name15(function SelectContentFragment2(props, forwardedRef) {
  const { __scopeSelect, children, fragment } = props;
  if (!fragment) return null;
  return ReactDOM3.createPortal(
    (0, import_jsx_runtime10.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime10.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime10.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
...
var SelectContentImpl = React26.forwardRef(
  // blank line to reduce diff noise
  __name15(function SelectContentImpl2(props, forwardedRef) {
    ...
    React26.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = __name15((event) => {
          pointerMoveDelta = {
            x: Math.abs(Math.round(event.pageX) - (triggerPointerDownPosRef.current?.x ?? 0)),
            y: Math.abs(Math.round(event.pageY) - (triggerPointerDownPosRef.current?.y ?? 0))
          };
        }, "handlePointerMove");
        const handlePointerUp = __name15((event) => {
    ...
    React26.useEffect(() => {
      const close = __name15(() => onOpenChange(false), "close");
...
var SelectItemAlignedPosition = React26.forwardRef(__name15(function SelectItemAlignedPosition2(props, forwardedRef) {
...
var SelectPopperPosition = React26.forwardRef(__name15(function SelectPopperPosition2(props, forwardedRef) {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React26.forwardRef(
  __name15(function SelectViewport2(props, forwardedRef) {
...
var SelectGroup = React26.forwardRef(
  __name15(function SelectGroup2(props, forwardedRef) {
...
var SelectLabel = React26.forwardRef(
  __name15(function SelectLabel2(props, forwardedRef) {
...
var SelectItem = React26.forwardRef(
  __name15(function SelectItem2(props, forwardedRef) {
    const {
      __scopeSelect,
      value,
      disabled = false,
...
var SelectItemText = React26.forwardRef(
  __name15(function SelectItemText2(props, forwardedRef) {
...
var SelectItemIndicator = React26.forwardRef(
  // blank line to reduce diff noise
  __name15(function SelectItemIndicator2(props, forwardedRef) {
...
var SelectScrollUpButton = React26.forwardRef(__name15(function SelectScrollUpButton2(props, forwardedRef) {
  ...
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      ...
      __name15(handleScroll22, "handleScroll");
...
var SelectScrollDownButton = React26.forwardRef(__name15(function SelectScrollDownButton2(props, forwardedRef) {
...
var SelectScrollButtonImpl = React26.forwardRef(__name15(function SelectScrollButtonImpl2(props, forwardedRef) {
...
var SelectSeparator = React26.forwardRef(
  // blank line to reduce diff noise
  __name15(function SelectSeparator2(props, forwardedRef) {
...
var SelectArrow = React26.forwardRef(
  __name15(function SelectArrow2(props, forwardedRef) {
    const { __scopeSelect, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeSelect);
    const contentContext = useSelectContentContext(ARROW_NAME2, __scopeSelect);
    return contentContext.position === "popper" ? (0, import_jsx_runtime10.jsx)(Arrow3, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }, "SelectArrow")
);
var BUBBLE_INPUT_NAME = "SelectBubbleInput";
var SelectBubbleInput = React26.forwardRef(
  // blank line to reduce diff noise
  __name15(function SelectBubbleInput2({ __scopeSelect, ...props }, forwardedRef) {
    ...
    return (0, import_jsx_runtime10.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) && !hasEmptyValueOption ? (0, import_jsx_runtime10.jsx)("option", { value: "" }) : null,
...
__name15(shouldShowPlaceholder, "shouldShowPlaceholder");
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React26.useCallback(
    (key) => {
      ...
      __name15((function updateSearch(value) {
...
__name15(useTypeaheadSearch, "useTypeaheadSearch");
...
__name15(findNextItem, "findNextItem");
function wrapArray(array, startIndex) {
  return array.map((_, index2) => array[(startIndex + index2) % array.length]);
}
__name15(wrapArray, "wrapArray");
export {
